...
window.HITT_USE_CASES = {
  ...
  "useCases": [
    ...
    },
    {
      ...
      "notes": [
        "Prints Kubernetes/OpenShift version and a node summary table: allocatable CPU (cores) and memory, allocated pod resource requests from Running pods only (CPU in cores), actual usage percentages (when metrics-server is available), node health/conditions, pod run/bad/crash counts, OOM kills, and container runtime.",
