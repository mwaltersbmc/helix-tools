...
window.HITT_USE_CASES = {
  ...
  "topics": [
    ...
    {
      "id": "fix-cluster",
      "title": "Fix mode & cluster operations",
      "order": 40
    },
    {
      "id": "troubleshooting",
      "title": "Debugging & message lookup",
      "order": 50
    }
  ],
  "useCases": [
    ...
    },
    {
      ...
      "commands": [
        "vi hitt.conf",
        "Or delete the file and re-run HITT to be prompted again:",
      ...
      "notes": [
        ...
        "Deleting hitt.conf forces the interactive wizard on next run (cluster must be reachable for namespace discovery unless you use overrides).",
    ...
    },
    {
      ...
      "topicId": "core-modes",
      "order": 30,
      "title": "I want to run the standard health checks (post-HP / pre-IS / post-IS / Jenkins)",
      "commands": [
      ...
      "notes": [
        "Requires hitt.conf (namespaces, CUSTOMER_SERVICE, ENVIRONMENT, Jenkins URL if applicable).",
        "post-hp and pre-hp skip Jenkins checks; see hitt/README.md for when to use each mode."
      ],
    ...
    },
    {
      ...
      "topicId": "utility",
      "order": 20,
      "title": "I want the live IS database ID (DBID) from the cluster",
      "commands": [
    ...
    },
    {
      ...
      "topicId": "utility",
      "order": 30,
      "title": "I want an AR-JWT for the IS REST API",
      "commands": [
    ...
    },
    {
      ...
      "topicId": "utility",
      "order": 50,
      "title": "I want a quick list of utility commands",
      "commands": [
        "bash hitt.sh -u help"
      ],
      "notes": [
        "Same content as README-utility-mode.md summary lines."
      ]
    },
    {
      "id": "pipeline-get",
      "topicId": "jenkins-pipelines",
      "order": 10,
      "title": "I want to check HELIX_ONPREM_DEPLOYMENT pipeline values before a deployment",
      "commands": [
      ...
      "notes": [
        ...
        "Useful to compare defaults vs last successful build before changing inputs."
      ],
    ...
    },
    {
      ...
      "topicId": "jenkins-pipelines",
      "order": 20,
      "title": "I want to push saved pipeline values into Jenkins as a new parameter build",
      "commands": [
    ...
    },
    {
      ...
      "topicId": "jenkins-pipelines",
      "order": 30,
      "title": "I want the latest Jenkins console log for a pipeline",
      "commands": [
    ...
    },
    {
      ...
      "topicId": "jenkins-pipelines",
      "order": 40,
      "title": "I want to display Jenkins credential usernames/passwords (sensitive)",
      "commands": [
        "bash hitt.sh -j"
      ],
      "notes": [
        "Also writes kubeconfig from Jenkins to kubeconfig.jenkins in the current directory when applicable.",
        "Use only on a trusted machine; rotate secrets if this output is ever leaked."
      ],
    ...
    },
    {
      ...
      "topicId": "jenkins-pipelines",
      "order": 60,
      "title": "I want to refresh Jenkins username/password and related credentials (except kubeconfig)",
      "commands": [
    ...
    },
    {
      ...
      "topicId": "fix-cluster",
      "order": 10,
      "title": "I want to replace the Helix IS cacerts secret with a new truststore file",
      "commands": [
    ...
    },
    {
      ...
      "topicId": "fix-cluster",
      "order": 20,
      "title": "I want to apply an AR / Innovation Suite license on the running system",
      "commands": [
    ...
    },
    {
      ...
      "topicId": "fix-cluster",
      "order": 30,
      "title": "I want the list of fix modes from the script",
      "commands": [
        "bash hitt.sh -f help"
      ],
      "notes": [
    ...
    },
    {
      ...
      "topicId": "fix-cluster",
      "order": 35,
      "title": "I want a tctl client config snippet (RSSO URL, client id/secret, app URL) from the cluster",
      "commands": [
        "bash hitt.sh -t config",
        "bash hitt.sh -t config > tctl-config.yaml"
      ],
      "notes": [
        "Special case: does not deploy the tctl job/pod. Reads TMS/RSSO secrets and deployment data from the Helix Platform namespace and prints YAML fields (appurl, clientid, clientsecret, enableauth, rssourl).",
    ...
    },
    {
      ...
      "topicId": "fix-cluster",
      "order": 50,
      "title": "I want IS bundle deployment status from a bundle ID",
      "commands": [
    ...
    },
    {
      ...
      "order": 10,
      "title": "I want shell trace (xtrace) while HITT runs",
      "commands": [
    ...
    },
    {
      ...
      "topicId": "troubleshooting",
      "order": 30,
      "title": "I want trace plus stop early for troubleshooting (debug + stop on first matching condition)",
      "commands": [
        "bash hitt.sh -d -e 0 -m post-is"
      ],
      "notes": [
        "-e 0 exits the script the first time stopOnError runs (any logged ERROR or WARNING that invokes it), which is useful to freeze right after the first failure while -d shows the command trace leading up to it.",
        "You can instead stop on a specific ID: bash hitt.sh -d -e 127 -m post-is"
      ],
      "seeAlso": "https://github.com/mwaltersbmc/helix-tools/blob/main/hitt/README.md#advanced-cli-options"
    }
  ]
